...
if __name__ == "__main__":
    ...
    # * create a producer instance --> utf-8
    ...
    order_card_type_list = ['Visa', 'Master',
                            'Maestro', 'American Express', 'Cirrus', 'PayPal']
    ...
    ecommerce_website_name_list = [
        "www.datamaking.com", "www.amazon.com", "www.flipkart.com", "www.snapdeal.com", "www.ebay.com"]
    ...
    for i in range(100):
        ...
        message["order_datetime"] = event_datetime.strftime(
            "%Y-%m-%d %H:%M:%S")
        country_name = None
        city_name = None
